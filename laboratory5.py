...
with st.expander('Области возможного применения:'):
            st.write('1.Чтение заявлений, служебных записок и других документов с последующим переносом их в печатный текст.')
            st.write('2.Чтение и распознавание исторических рукописных документов.')
            st.write('3.Автоматическое заполнение баз данных при рассмотрении письменных показаний свидетелей.')
...
st.write('1) Марк Лутц "Изучаем Python".')
